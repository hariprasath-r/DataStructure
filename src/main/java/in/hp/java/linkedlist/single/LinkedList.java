...
public class LinkedList {
    ...
    /**
     * @param data 1. Creating a new node to hold the data
    ...
    /**
     * @param data 1. Creating a new Node and setting the received value
    ...
    /**
     * @param index
     * @param data  1. Index values will always start from 0 in code but will receive proper values as input
    ...
    /**
     * @param index 1. if index is 0, delete the head value by assigning next element to head.
